 ...
 * @param {URI} the uri with the queries appended
 */
...
/**
 * Returns options required for 'utils.url'.
 *
 * @param {Array} sources
 * @param {Object} dest
 * @return {Object}
...
/**
 * Remove options applicable for `utils.url`
 *
 * @param {Object} params...
 */
...
/**
 * Chuck Auth options from an object
 *
 * @param {Array} sources
 * @param {Object} dest
 * @return {Object}
